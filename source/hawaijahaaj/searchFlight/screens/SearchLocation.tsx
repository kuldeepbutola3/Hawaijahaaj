...
import { AppNavigationProp, AppRouteProp } from '../../../navigation/AppNav';
...
export const SearchLocation = () => {
  ...
  const { fieldType } = useRoute<AppRouteProp<'SearchLocation'>>().params;
    ...
    <SafeAreaView style={styles.container}>
      ...
      <SafeAreaView style={styles.modalContainer}>
        <View style={styles.modalHeader}>
          <TouchableOpacity onPress={back} style={{ paddingRight: 10 }}>
