...
import { flightImagePath } from '../../../hw/flight/FlightModel';
    ...
    <View>
      <View style={styles.headerContainer}>
        <View style={styles.headerInner1}>
          <Text style={styles.headerInner1Text}>
            {t('depart').toUpperCase()}
          </Text>
        ...
        <View style={styles.headerInner2}>
          <Text
            style={
              styles.headerInner2Text
            }>{`${startDestination}-${endDestination}`}</Text>
          <Text style={styles.headerInner2SubText}>{depart}</Text>
        </View>
      </View>
      <View style={styles.headerView}>
        <Image
          source={flightImagePath(imagename)}
