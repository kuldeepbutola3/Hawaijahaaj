...
export const DatePicker: React.FC<DatePickerProps & ComponentProps> = props => {
  return (
    Platform.select({
...
const AndroidDatePicker: React.FC<DatePickerProps & ComponentProps> = ({
  containerStyle,
...
const IOSDatePicker: React.FC<DatePickerProps & ComponentProps> = ({
  children,
  containerStyle,
  onValueChange,
  value,
