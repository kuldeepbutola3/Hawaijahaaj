...
export default class App extends Component {
  ...
  render() {
    // function doneTapped(params) {

    // }
    console.log('propssssss 22222', this.props);
    // if (this.props.paymentMode) {
    //   this.launchPayU;
    // }
    const userData = this.props.paymentMode;
    return (
      <>
        {userData?.pGUserMappingModelList?.map((obj, index) => {
          return (
            <Button
              bgColor={appColors.pink}
              title={obj.paymentGatewayModel.description}
              onPress={() => {
                this.launchPayU();
              }}
            />
  ...
  createPaymentParams = () => {
    ...
    var payUCheckoutProConfig = {
      ...
      showExitConfirmationOnCheckoutScreen:
        this.state.showExitConfirmationOnCheckoutScreen,
      showExitConfirmationOnPaymentScreen:
        this.state.showExitConfirmationOnPaymentScreen,
